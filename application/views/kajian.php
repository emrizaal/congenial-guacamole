                                ...
                                foreach($data['collection'] as $d){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=API_LINK?>/kajian/deleteKajian/<?=$d['id_kajian']?>/<?=$this->session->userdata('token')?>/<?=$this->session->userdata('id_mosque')?>" onclick="return confirm('Are you sure you ?');"><button class="btn btn-danger"><span class="fa fa-eraser"></span></button></a>
